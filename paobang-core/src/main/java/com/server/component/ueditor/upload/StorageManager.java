...
public class StorageManager {
	...
	public static String saveFileByInputStream(InputStream is, String path) {
		BufferedInputStream bis = new BufferedInputStream(is, StorageManager.BUFFER_SIZE);
		try {
			String url=OSSUtil.putObject("xiangduke", "image/"+UUID.randomUUID().toString()+path, bis);
//			url=url.replace("http://xiangduke.oss-cn-zhangjiakou.aliyuncs.com/", "");
			return url;
		} catch (IOException e) {
		}
		return null;
